...
namespace crypto_lab_3.Kupyna
{
    ...
    {
        public static Dictionary<string, byte> getPI0()
        {
            Dictionary<string, byte> PI_0 = new Dictionary<string, byte>();
        ...
        public static Dictionary<string, byte> getPI1()
        {
            Dictionary<string, byte> PI_1 = new Dictionary<string, byte>();
        ...
        public static Dictionary<string, byte> getPI2()
        {
            Dictionary<string, byte> PI_2 = new Dictionary<string, byte>();
        ...
        public static Dictionary<string, byte> getPI3()
        {
            Dictionary<string, byte> PI_3 = new Dictionary<string, byte>();
        ...
        private static string[] PiKeys = new String[]{
    ...
    private static byte[] S1 = new byte[]{(byte) 0xce, (byte) 0xbb, (byte) 0xeb, (byte) 0x92, (byte) 0xea, (byte) 0xcb,
    ...
    private static byte[] S2 = new byte[]{(byte) 0x93, (byte) 0xd9, (byte) 0x9a, (byte) 0xb5, (byte) 0x98, (byte) 0x22,
    ...
    private static byte[] S3 = new byte[]{(byte) 0x68, (byte) 0x8d, (byte) 0xca, (byte) 0x4d, (byte) 0x73, (byte) 0x4b,
